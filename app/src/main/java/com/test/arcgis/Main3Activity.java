package com.test.arcgis;/* Copyright 2017 Esri
 *
...
public class Main3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // define pin drawable
        BitmapDrawable pinDrawable = (BitmapDrawable) ContextCompat.getDrawable(this, R.drawable.arcgisruntime_location_display_default_symbol);
        try {
                    ...
                    suggestionsFuture.addDoneListener(new Runnable() {
                        ...
                        @Override public void run() {
                            try {
                                ...
                                final SimpleCursorAdapter suggestionAdapter = new SimpleCursorAdapter(Main3Activity.this,
                                        R.layout.spinner_layout, suggestionsCursor, cols, to, 0);
                            ...
                            public void run() {
                                try {
                                    ...
                                    if (geocodeResults.size() > 0) {
                                        ...
                                        Toast.makeText(getApplicationContext(), "未找到" + address,
                                                Toast.LENGTH_LONG).show();
                                    }
                                } catch (InterruptedException | ExecutionException e) {
                                    Log.e(TAG, "Geocode error: " + e.getMessage());
                                    Toast.makeText(getApplicationContext(), "Geocode failed on address", Toast.LENGTH_LONG)
                                            .show();
                                }
                            }
                        });
